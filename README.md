About pyfolio-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyfolio-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/quantopian/pyfolio
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5988&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyfolio-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyfolio` can be installed with `conda`:
...
```
mamba install pyfolio
```

It is possible to list all of the versions of `pyfolio` available on your platform with `conda`:
...
```
mamba search pyfolio --channel conda-forge
```
...
mamba repoquery search pyfolio --channel conda-forge

# List packages depending on `pyfolio`:
mamba repoquery whoneeds pyfolio --channel conda-forge

# List dependencies of `pyfolio`:
mamba repoquery depends pyfolio --channel conda-forge
```
